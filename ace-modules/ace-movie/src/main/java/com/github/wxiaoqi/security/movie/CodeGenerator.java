...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        strategy.setSuperEntityClass("com.github.wxiaoqi.security.movie.system.base.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        strategy.setSuperControllerClass("com.github.wxiaoqi.security.movie.system.base.BaseController");
